...
<%@ page import="movieborad.wrestler"%>
...
<body>
	...
	%>
		...
		<iframe width="1280" height="720" src="https://www.youtube.com/embed/Ek_EtyseqkE" allowfullscreen ></iframe>
		</div>
		<br><br><br>
		<div class="container">
			<div class="row">
			<form method="post" action="wrestlerAction.jsp">
				<table class="table table-striped" style="text-align: center; border : 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><textarea rows="5" class="form-control" placeholder="댓글내용" name="wrestlerContent" maxlength="2048"></textarea></td>
						</tr>
					</tbody>
				 </table>
			...
			<div class="row">
				<table class="table table-striped" style="text-align: center; border : 1px solid #dddddd">
					...
					<%
						...
						ArrayList<wrestler> list = wrestlerDAO.getList(pageNumber);
						for(int i = 0 ; i <list.size(); i++){
					%>
						<tr>
							<td><%= list.get(i).getIdx() %></td>
							<td><%= list.get(i).getWrestlerContent()%></td>
